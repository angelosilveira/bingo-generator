...
export default function NewBingoPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err)
      toast.error(err.message || 'Erro ao gerar cartelas. Tente novamente.')
    } finally {
      setSubmitting(false)
    }
  }
      ...
      <header className="bg-[#1a3a6b] shadow-md">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-blue-300 text-xs">Configure e visualize antes de gerar</p>
          </div>
        </div>
      </header>
            ...
            >
              {submitting ? (
                <>
                  ...
                  Gerando {form.quantidadeCartelas} cartelas…
                </>
              ) : (
                <>
                  <Upload size={20} />
